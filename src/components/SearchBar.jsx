  ...
  return (
    <div className={`flex justify-center items-center w-full transition-all duration-300 ${isOpen ? 'absolute top-0 left-0 w-full bg-white h-24 z-50' : 'w-auto'}`}>
        ...
        <div className="relative w-1/2 flex justify-center items-center gap-4">
            <input type="text" placeholder="Type here..." value={searchForm} onChange={e => setSearchForm(e.target.value)} className="bg-gray-100 px-4 py-2 pl-3 pr-12 rounded-xl focus:outline-none w-full placeholder:text-gray-700"/>
            <button type="submit">
